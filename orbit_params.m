...
mag.bias = ((rand(3,1)) - 0.5) * 500;


mag.Ts = 0.5;

mag.scales = ((rand(3,3) - 0.5) /50 .* [1,0.1,0.1;0.1,1,0.1;0.1,0.1,1] + eye(3))^-1;   %% 1 percent
mag.sigma  = 100;
mag.co_var = ones(3,1) * mag.sigma^2;
mag.noise_seeds = randi([1,1000],3,1);

mag2 = mag;
mag2.scales = ((rand(3,3) - 0.5) /50 .* [1,0.1,0.1;0.1,1,0.1;0.1,0.1,1] + eye(3))^-1;   %% 1 percent
mag2.sigma  = 100;
